...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h3 class="mb-1">Добавить книгу</h3>
        <div class="text-muted">Новая книга в электронную библиотеку</div>
    </div>
    ...
    <form method="POST" action="{{ route('admin.books.store') }}" enctype="multipart/form-data">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-3">
                ...
                <input type="number" step="0.01" name="price_per_page" class="form-control" value="{{ old('price_per_page', 0) }}" required>
            </div>
            ...
            <div class="col-md-4">
                <label class="form-label">PDF книги</label>
            ...
            <div class="col-md-4">
                ...
                <div class="form-check mt-2">
                    <input class="form-check-input" type="checkbox" name="is_discount" value="1" id="is_discount" @checked(old('is_discount'))>
        ...
        <div class="mt-4">
            <button type="submit" class="btn btn-brand">Сохранить книгу</button>
        </div>
    </form>
</div>
@endsection